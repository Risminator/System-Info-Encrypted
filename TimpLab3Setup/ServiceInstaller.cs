...
namespace TimpLab3Setup
{
    class ServiceInstaller
    {
        ...
        public static bool InstallService(string svcPath, string svcName, string svcDispName, string[] args)
        {
            ...
            try
            {
                ...
                if (sc_handle.ToInt32() != 0)
                {
                    ...
                    else
                    {
                        ...
                        int i = StartService(sv_handle, 1, path);
        ...
        public static void Test()
        {
            ...
            svcPath = @"C:\Users\Risovator\CLionProjects\SecurDaemon\cmake-build-debug\SecurDaemon.exe";
            svcDispName = "AAAA";
            svcName = "AAAA";

            string path = "C:\\Users\\Risovator\\Desktop";
            string[] args = new string[] { path };

            //ServiceInstaller.InstallService(svcPath, svcName, svcDispName, args);
            //ServiceInstaller.UnInstallService(svcName);
